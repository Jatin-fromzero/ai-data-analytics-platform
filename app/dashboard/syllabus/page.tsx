  ...
  return (
    <PageReveal>
      <div className="space-y-16 lg:space-y-24 pb-20 max-w-6xl mx-auto">
        ...
        {/* ── HEADER (Adapted for authenticated workspace view) ──────────────────────── */}
        <div className="relative pt-8 pb-12 border-b border-white/[0.04] bg-white/[0.01] rounded-2xl p-6 sm:p-8 overflow-hidden shadow-sm">
          ...
          <FadeUp>
            <div className="max-w-3xl space-y-4">
              <Badge variant="outline" className="border-brand/30 text-brand uppercase tracking-widest text-[9px] font-bold">
                Workspace Curriculum
              </Badge>
              <h1 className="text-3xl sm:text-5xl font-extrabold text-foreground tracking-tight">
                Curriculum Milestone Blueprint.
              </h1>
              <p className="text-sm sm:text-base text-muted font-light leading-relaxed max-w-2xl">
                Explore the structured technical blueprints across all 5 career tracks. Initialize your student operating system workspace dynamically by monitoring milestones in real-time.
              </p>
            </div>
          </FadeUp>
        </div>
            ...
            {(Object.keys(courseSyllabi) as Array<keyof typeof courseSyllabi>).map((key) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      layoutId="activeStudentSyllabusTab"
                  ...
                  <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                    <div className="min-w-0 flex-1 space-y-4">
                      <div className="flex flex-wrap items-center gap-3">
                        <span 
                          className="flex h-7 w-7 items-center justify-center rounded-full text-xs font-bold text-slate-950 shadow-[0_0_12px_rgba(255,107,53,0.15)]"
                          style={{ backgroundColor: phase.color }}
                        >
                          {phase.phase}
                        </span>
                        ...
                        <Badge className="bg-slate-800 text-slate-300 hover:bg-slate-700 border-none text-[10px]">{phase.difficulty}</Badge>
                      </div>
        ...
        <ScrollReveal>
          <section className="text-center space-y-6 pt-16 border-t border-white/[0.04] max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-foreground">Track your milestones directly in your workspace.</h2>
