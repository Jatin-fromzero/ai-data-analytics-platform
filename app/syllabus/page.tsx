  ...
  return (
    <PageReveal>
      <div className="space-y-16 lg:space-y-24 pb-20">
        ...
        <div className="relative pt-20 pb-16 text-center border-b border-border/50 bg-surface/30 overflow-hidden">
          ...
          <FadeUp>
            <div className="max-w-3xl mx-auto px-4">
              <Badge variant="outline" className="mb-6 border-brand/30 text-brand uppercase tracking-widest">Structured Curriculum</Badge>
              <h1 className="text-4xl sm:text-6xl font-extrabold text-foreground tracking-tight leading-[1.15]">
                The 16-Week <br />
                <span className="text-brand italic font-light">Data Analytics Path.</span>
              </h1>
        ...
        {/* ── SYLLABUS GRID ──────────────────────────────────────────────── */}
        <section className="mx-auto max-w-4xl space-y-16 px-4">
          {syllabusPhases.map((phase) => (
            <ScrollReveal key={phase.phase} delay={0.1}>
        ...
        <ScrollReveal>
          <section className="mx-auto max-w-4xl text-center space-y-8 pt-16 border-t border-border/50 px-4">
            <h2 className="text-3xl font-bold text-foreground">Ready to master the analytics stack?</h2>
            <Button size="lg" className="shadow-[0_0_40px_rgba(255,107,53,0.3)] h-12 px-10 rounded-full text-base">Enroll in the Complete Path</Button>
          </section>
        </ScrollReveal>
      </div>
    </PageReveal>
